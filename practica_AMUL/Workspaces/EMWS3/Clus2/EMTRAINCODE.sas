...
MAKE outvar=EMWS3.Clus2_OUTVAR;
INITIAL radius=0
;
TRAIN tech=FORGY
;
SAVE outstat=EMWS3.Clus2_OUTSTAT outmean=EMWS3.Clus2_OUTMEAN;
code file="C:\Users\Admin\Documents\GitHub\AMUL-PRACTICA\practica_AMUL\Workspaces\EMWS3\Clus2\DMVQSCORECODE.sas"
group=Clus2
;
run;
quit;
